...
public class DashboardActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSearchText = (AutoCompleteTextView) findViewById(R.id.search_by_till);
...
//                            MtibaRequest sendcord = new MtibaRequest();
//                            sendcord.getclinic(latitude, longitude, new Callback() {
//                                @Override
...
//
//                                            JSONObject jsonresp = jArray.getJSONObject(i);
//
...
//                                            // create marker
//                                            MarkerOptions client_marker = new MarkerOptions().position(new LatLng(lat, longi));
//                                            client_marker.icon(BitmapDescriptorFactory.fromResource(R.drawable.maker));
//                                            // adding marker
...
//                            });
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo){
        ...
        mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(DashboardActivity.this));
